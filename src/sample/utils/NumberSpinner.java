...
public class NumberSpinner extends HBox {
    ...
    public NumberSpinner() {
        this(BigDecimal.valueOf(1000), BigDecimal.valueOf(100));
    }
    ...
    public void dumpSizes() {
        Log.cout("numberField (layout)=" + numberField.getLayoutBounds());
        Log.cout("buttonInc (layout)=" + incrementButton.getLayoutBounds());
        Log.cout("buttonDec (layout)=" + decrementButton.getLayoutBounds());
        Log.cout("binding=" + buttonHeight.toString());
        Log.cout("spacing=" + spacing.toString());
    }
}